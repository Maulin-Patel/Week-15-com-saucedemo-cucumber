...
public class LoginPageSteps {
    ...
    public void iShouldSeeTextProducts() {
        ...
        String actualMessage = new ProductPage().verifyTextProducts();
        Assert.assertEquals("Products not displayed.", expectedMessage, actualMessage);
    }

    @Then("^I should see six products are displayed on home page$")
    public void iShouldSeeSixProductsAreDisplayedOnHomePage() {
        int expectedQty = 6;
        int actualQty = new ProductPage().verifyTotalProductOfNumber();
